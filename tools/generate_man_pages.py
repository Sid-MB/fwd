...
def watch(output_dir: Path, *, date: str | None) -> int:
...
def main() -> int:
    ...
    if arguments.watch:
        return watch(output_dir, date=arguments.date)
    return generate(output_dir, date=resolve_manual_date(arguments.date), check=arguments.check)
