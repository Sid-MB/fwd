...
def main() -> int:
    ...
    parser.add_argument("--date", help=f"Manual source date in YYYY-MM-DD form (default: {MANUAL_DATE}).")
    ...
    return generate(output_dir, date=arguments.date or MANUAL_DATE, check=arguments.check)
