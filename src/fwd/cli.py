...
def setup_cmd(
    ...
    region: Annotated[str | None, typer.Option("--region", help="Exact Lambda region code, or auto to choose from current capacity (default: auto).")] = None,
    preferred_region: Annotated[list[str] | None, typer.Option("--preferred-region", help="Preferred Lambda region code or prefix; repeat in priority order. Used when --region is auto.")] = None,
    ...
    wizard.run_wizard(
        ...
        values={
            ...
            "region": region,
            "preferred_regions": preferred_region,
